...
const ProfessionalComponent: React.FC<Professional> = ({
  id,
  name,
  license_number,
  ...
  const [scheduleAppointmentDialogOpen, setScheduleAppointmentDialogOpen] =
        ...
        <div className="flex flex-col flex-grow min-w-[60%]">
          <div className="flex flex-col flex-grow">
            ...
            <p className="text-lg text-gray-500">
              {professional_category.name} • {license_number}N
            </p>
          </div>
          {services.length > 0 && (
            <Services
