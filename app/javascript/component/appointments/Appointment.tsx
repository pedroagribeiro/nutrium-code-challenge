  ...
  return (
    <div className="flex flex-col rounded-sm border-1 border-gray-300">
      ...
      <button
        ...
        className="text-[#20b194] text-lg font-semibold border-t-1 border-gray-300 py-3 bt-1 hover:bg-gray-100"
      >
        {t('appointments.answer')}
      </button>
      <AppointmentDialog isOpen={dialogOpen} setOpen={setDialogOpen} appointment={appointment} />
    </div>
  );
};
